...
<p>Абстрагируйте все гарнитуры из гайдлайна в короткие имена-маркеры.</p>
<p><code class="nowrap">~/src/stylus/utils/_typography.styl</code></p>
<div class="language-stylus ext-styl line-numbers-mode"><pre v-pre class="language-stylus"><code><span class="token comment">// Typography</span>
...
<span class="token comment">// Import fonts</span>
<span class="token comment">//////////////////////////////////////////////////////</span>

<span class="token atrule-declaration"><span class="token atrule">@font-face</span></span>
  <span class="token property-declaration"><span class="token property">font-family</span> $font-family</span>
  <span class="token property-declaration"><span class="token property">src</span> <span class="token url">url("../../static/fonts/Ubuntu/Ubuntu-Regular.eot")</span></span>
  src <span class="token func"><span class="token function">local</span><span class="token punctuation">(</span><span class="token string">"Ubuntu Regular"</span><span class="token punctuation">)</span><span class="token punctuation">,</span> local<span class="token punctuation">(</span><span class="token string">"Ubuntu-Regular"</span><span class="token punctuation">)</span><span class="token punctuation">,</span></span>
    ...
    <span class="token func"><span class="token function">url</span><span class="token punctuation">(</span><span class="token string">"../../static/fonts/Ubuntu/Ubuntu-Regular.ttf"</span><span class="token punctuation">)</span> format<span class="token punctuation">(</span><span class="token string">"truetype"</span><span class="token punctuation">)</span></span>
  <span class="token property-declaration"><span class="token property">font-weight</span> $font-weight.regular</span>
  <span class="token property-declaration"><span class="token property">font-style</span> normal</span>

<span class="token atrule-declaration"><span class="token atrule">@font-face</span></span>
  <span class="token property-declaration"><span class="token property">font-family</span> $font-family</span>
  <span class="token property-declaration"><span class="token property">src</span> <span class="token url">url("../../static/fonts/Ubuntu/Ubuntu-Bold.eot")</span></span>
  src <span class="token func"><span class="token function">local</span><span class="token punctuation">(</span><span class="token string">"Ubuntu Bold"</span><span class="token punctuation">)</span><span class="token punctuation">,</span> local<span class="token punctuation">(</span><span class="token string">"Ubuntu-Bold"</span><span class="token punctuation">)</span><span class="token punctuation">,</span></span>
    ...
    <span class="token func"><span class="token function">url</span><span class="token punctuation">(</span><span class="token string">"../../static/fonts/Ubuntu/Ubuntu-Bold.ttf"</span><span class="token punctuation">)</span> format<span class="token punctuation">(</span><span class="token string">"truetype"</span><span class="token punctuation">)</span></span>
  <span class="token property-declaration"><span class="token property">font-weight</span> $font-weight.bold</span>
  <span class="token property-declaration"><span class="token property">font-style</span> normal</span>
